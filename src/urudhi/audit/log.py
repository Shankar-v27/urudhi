...
class EventKind(enum.StrEnum):
    ...
    COMMITMENT_PROPOSED = "commitment_proposed"      # structured promise put to policy
    COMMITMENT_APPROVED = "commitment_approved"      # policy accepted amount + deadline
    COMMITMENT_BLOCKED = "commitment_blocked"        # policy refused; promise stays as evidence
    COMMITMENT_CREATED = "commitment_created"        # executable commitment on the ledger
    PAYMENT_INSTRUMENT_CREATED = "payment_instrument_created"  # rail-side link / VA issued
    COMMITMENT_PARTIALLY_FULFILLED = "commitment_partially_fulfilled"
    ...
    RAIL_FAILED = "rail_failed"               # payment rail refused/failed; nothing sent or issued
